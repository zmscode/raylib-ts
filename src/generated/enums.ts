...
export type ConfigFlags = (typeof ConfigFlags)[keyof typeof ConfigFlags];

/** Trace log level */

export const TraceLogLevel = {
	/** Display all logs */
	LOG_ALL: 0,
...
export type MouseCursor = (typeof MouseCursor)[keyof typeof MouseCursor];
...
export type MaterialMapIndex = (typeof MaterialMapIndex)[keyof typeof MaterialMapIndex];

/** Shader location index */

export const ShaderLocationIndex = {
...
export type ShaderLocationIndex = (typeof ShaderLocationIndex)[keyof typeof ShaderLocationIndex];

/** Shader uniform data type */

export const ShaderUniformDataType = {
...
export type ShaderUniformDataType = (typeof ShaderUniformDataType)[keyof typeof ShaderUniformDataType];

/** Shader attribute data types */

export const ShaderAttributeDataType = {
...
export type ShaderAttributeDataType = (typeof ShaderAttributeDataType)[keyof typeof ShaderAttributeDataType];
...
export type CubemapLayout = (typeof CubemapLayout)[keyof typeof CubemapLayout];
...
export type CameraProjection = (typeof CameraProjection)[keyof typeof CameraProjection];

/** N-patch layout */

export const NPatchLayout = {
...
export type NPatchLayout = (typeof NPatchLayout)[keyof typeof NPatchLayout];
